...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = @'
Initial release of WorkMode-Hostess module with the following features:

- Manual mode switching between Work and Normal modes
- Automatic time tracking with JSON storage
- Productivity statistics and insights
- Website blocking using hostess utility
